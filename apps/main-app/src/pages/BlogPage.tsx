...
const BlogPage: React.FC = () => {
  const blogPosts = [
    {
      ...
      excerpt: "Discover what Reiki is, how it works, and what to expect during your first session. Learn about the ancient Japanese healing technique that's helping millions find peace and balance.",
      date: "2024-12-15",
      readTime: "5 min read",
    ...
    {
      id: 2,
      title: "The Science Behind Sound Healing: How Vibrations Transform Wellness",
      excerpt: "Explore the fascinating research behind sound therapy and how specific frequencies can promote healing, reduce stress, and improve overall well-being.",
      date: "2024-12-10",
      readTime: "7 min read",
    ...
    },
    {
      ...
      excerpt: "A comprehensive guide to help you prepare for your first Reiki experience, including what happens during a session and how to maximize the benefits.",
      date: "2024-12-05",
      readTime: "4 min read",
    ...
    },
    {
      ...
      excerpt: "Learn about the seven main chakras, their functions, and how Reiki can help balance these vital energy centers for optimal health and vitality.",
      date: "2024-11-28",
      readTime: "6 min read",
    ...
    {
      id: 5,
      title: "Stress Relief Through Energy Healing: Natural Solutions for Modern Life",
      excerpt: "Discover how Reiki and sound healing can provide natural, effective relief from stress, anxiety, and the pressures of daily life.",
      date: "2024-11-20",
      readTime: "5 min read",
    ...
    },
    {
      ...
      excerpt: "Learn how to create a peaceful environment and set clear intentions to enhance your healing journey and spiritual growth.",
      date: "2024-11-15",
      readTime: "4 min read",
  ...
  const categories = ["All", "Reiki Basics", "Sound Therapy", "Getting Started", "Energy Work", "Wellness", "Spiritual Growth"];
      ...
      <ResponsiveContainer variant="page" className="pt-24 pb-16">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Discover the transformative power of energy healing through articles about Reiki, 
            sound therapy, holistic wellness, and spiritual growth. Your journey to inner peace starts here.
          </p>
        </div>
      </ResponsiveContainer>
        ...
        <div className="bg-gradient-to-br from-blue-700 to-cyan-400 rounded-2xl p-12 text-center text-white">
          <div className="space-y-6">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto">
              Subscribe to receive weekly insights, healing tips, and updates about new blog posts 
              and special offers on Reiki sessions.
            </p>
        ...
        <div className="bg-amber-50 rounded-2xl p-12 text-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Reading about healing is just the beginning. Take the next step and experience 
              the transformative power of Reiki and sound therapy in person.
            </p>
