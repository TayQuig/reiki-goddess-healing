          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                At The Reiki Goddess Healing, we are committed to protecting
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 ml-6 text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Contact information (name, email, phone number) when you
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blue-700 mt-1">•</span>
                  <span>
                    Health and wellness information you share during
                    consultations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-700 mt-1">•</span>
                  <span>
                    Payment information for session bookings (processed securely
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                cookie settings through your browser preferences. Some features
            ...
            <section className="space-y-4">
              ...
              <div className="bg-blue-50 rounded-lg p-6 space-y-2">
                ...
                <p className="text-gray-700">Phone: 0300 0000 0000</p>
                <p className="text-gray-700">Location: Roy, Washington</p>
              </div>
            </section>
          </div>
