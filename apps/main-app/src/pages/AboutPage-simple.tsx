      ...
      <ResponsiveContainer variant="page" className="pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              With years of experience in energy healing and holistic wellness, I blend the gentle art of Reiki 
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border p-6 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-600">Supporting clients in emotional, physical, and spiritual growth.</p>
          </div>
          
          <div className="bg-white border p-6 rounded-2xl shadow-lg">
            <h3 className="text-lg font-bold mb-2">Certified Reiki Master</h3>
            <p className="text-gray-600">Advanced training in energy healing techniques.</p>
          </div>
        </div>
      </ResponsiveContainer>
