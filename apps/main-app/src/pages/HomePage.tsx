  ...
  const services = [
    {
      title: "Reiki Healing",
      description:
        "Experience the gentle power of energy healing to restore balance and promote deep relaxation.",
      icon: "🔮",
      benefits: [
        "Stress Reduction",
        "Pain Relief",
    ...
    },
    {
      title: "Sound Therapy",
      description:
        "Therapeutic vibrations using singing bowls and instruments to heal body, mind, and spirit.",
      icon: "🎵",
      benefits: [
        "Deep Relaxation",
        "Anxiety Relief",
    ...
    },
    {
      ...
      description:
        "Comprehensive approach combining energy healing techniques for complete wellness.",
      icon: "🧘‍♀️",
      benefits: [
        "Mind-Body Balance",
        "Inner Peace",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[600px]">
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-700 leading-relaxed max-w-xl">
              Transform your life through the ancient art of Reiki energy
              healing and sound therapy. Discover inner peace, release emotional
              blockages, and restore harmony to your body, mind, and spirit.
            </p>
        ...
        <div className="text-center space-y-16">
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Experience personalized healing sessions designed to restore
              balance, reduce stress, and awaken your inner wisdom through
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                As a certified Reiki Master and Sound Healer based in Roy,
                Washington, I bring years of experience in energy healing and
                holistic wellness to help you release stress, restore balance,
                and awaken your inner strength.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                My approach is warm, intuitive, and personalized — ensuring
                every session supports your unique journey toward healing and
                self-discovery.
              </p>
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4h3a1 1 0 110 2h-1v9a2 2 0 01-2 2H7a2 2 0 01-2-2V9H4a1 1 0 110-2h3z"
                    />
                  </svg>
                </Link>
              </div>
        ...
        <div className="text-center space-y-12">
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-700 max-w-2xl mx-auto">
              Discover how Reiki healing has transformed the lives of our
              clients
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-700 to-cyan-400 rounded-3xl p-12 text-center text-white shadow-2xl">
          <div className="space-y-8">
            ...
            <p className="text-xl max-w-3xl mx-auto leading-relaxed opacity-90">
              Take the first step toward balance, peace, and wellness. Schedule
              your personalized Reiki and sound healing session today and
