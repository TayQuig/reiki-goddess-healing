...
export const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  services = [
    ...
    },
    {
      id: 'aura',
      icon: (
        <img src="/img/triangle_1377047-aura-chakra-readings.svg" alt="Aura Chakra" />
      ),
      title: 'Aura + Chakra',
      duration: 'Readings',
    ...
    },
    {
      id: 'distance',
      icon: (
        <img src="/img/music-therapy_1330537-distance-healing-sessions.svg" alt="Distance Healing" />
      ),
  ...
  return (
    <section className={`py-20 ${className}`} style={{ backgroundColor: '#FFFBF5' }}>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = '0px 42px 40px -10px rgba(2, 5, 183, 0.35)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = '0px 42px 32.5px -13px rgba(2, 5, 183, 0.25)';
                }}
              >
              ...
              {/* Card Content */}
              <div 
                className="h-[280px] p-6 flex flex-col items-center justify-center text-center relative"
              >
