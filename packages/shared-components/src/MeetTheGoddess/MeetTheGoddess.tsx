...
export const MeetTheGoddess: React.FC<MeetTheGoddessProps> = ({
  ...
  content = (
    <>
      <p className="mb-4">
        A certified Reiki master, trauma-informed healer, and sound therapist based in Roy, WA. 
        Her compassion, grace, and authentic presence help clients transform from stressed, anxious, 
        and disconnected to feeling grounded, balanced, and at peace.
      </p>
      <p className="mb-4">
        In my dream holistic shop alongside skilled, ethical, and joyful healers who operate in integrity, 
        a space for connection, transformation, and healing unfolds. Together, we create a sanctuary where 
        individuals journey towards wellness, find inner peace, and reconnect with their authentic selves 
