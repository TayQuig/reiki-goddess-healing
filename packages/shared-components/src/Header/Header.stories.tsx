...
export const ProofOfConcept = () => (
  <div style={{ padding: "20px", fontFamily: "system-ui, sans-serif" }}>
    ...
    <ul>
      <li>
        <strong>Dimensions:</strong> 716px × 93px
      </li>
      <li>
        <strong>Typography:</strong> Figtree, 16px, semibold
      </li>
      <li>
        <strong>Colors:</strong> CSS variables from design system
      </li>
      <li>
        <strong>Layout:</strong> Flexbox with 84px gaps
      </li>
      <li>
        <strong>Logo:</strong> 248px × 92px with 2.7:1 aspect ratio
      </li>
    </ul>
